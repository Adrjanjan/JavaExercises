...
//    public Node diff(Variable var) {
////        this.simplify();
//        if(getArgumentsCount() == 2){
//            return new Sum(new Prod(args.get(0) , args.get(1).diff(var)),new Prod(args.get(1) , args.get(0).diff(var)));
//        }
//
//        Prod p = new Prod();
//        p.args = new ArrayList<>(this.args);
//        p.args.remove(0);
//        return new Sum(new Prod(args.get(0) , p.diff(var)),new Prod(p , args.get(0).diff(var)));
//    }
